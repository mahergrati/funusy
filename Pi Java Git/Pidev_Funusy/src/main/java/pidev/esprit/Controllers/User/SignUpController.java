    ...
    void signUp(ActionEvent event) {
        if (validateFields()) {
            ...
            boolean registrationSuccessful = UserController.registerUser(
                    nom_user, prenom_user, email_user, hashedPassword, salaire, date_naissance.toLocalDate(), CIN, tel, adresse_user, role_user);

            if (registrationSuccessful) {
                User newUser = new User(nom_user, prenom_user, email_user, hashedPassword, salaire, date_naissance, CIN, tel, adresse_user, role_user);
